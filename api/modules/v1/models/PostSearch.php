...
class PostSearch extends Post
{
    ...
    public function searchMyPost($params)
    {
        ...
        $query = Post::find()
            ...
            ->select(['post.id', 'post.type', 'post.post_content_type','post.content_type_reference_id','post.unique_id', 'post.user_id', 'post.title','post.description', 'post.competition_id', 'post.club_id', 'post.event_id',  'post.campaign_id', 'post.image', 'post.total_view', 'post.total_like', 'post.total_comment', 'post.total_share', 'post.popular_point', 'post.status', 'post.created_at', 'post.latitude', 'post.longitude', 'post.address','post.poll_id','post.is_comment_enable'])
    ...
    public function PostPromotionAd($params)
    {
        ...
        $query = Post::find()
            ->select(['post.id', 'post.type', 'post.post_content_type','post.content_type_reference_id','post.unique_id', 'post.user_id', 'post.title', 'post.description','post.competition_id', 'post.club_id','post.event_id','post.campaign_id', 'post.image', 'post.total_view', 'post.total_like', 'post.total_comment', 'post.total_share', 'post.popular_point', 'post.status', 'post.created_at', 'post.latitude', 'post.longitude', 'post.address', 'post.audio_id', 'post.audio_start_time', 'post.audio_end_time', 'post.is_add_to_post','post.poll_id','post.is_comment_enable'])
