...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return ['isFollowing', 'isFollower', 'totalFollowing', 'totalFollower', 'totalPost', 'totalActivePost', 'totalWinnerPost', 'totalReel', 'totalClub', 'totalMention', 'userLiveDetail', 'giftSummary', 'follower', 'following', 'interest', 'userSetting', 'language','pickleballSummary','featureList'];
    }
